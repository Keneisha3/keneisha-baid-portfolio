...
function ProjectCard({ project, index }) {
  return (
    ...
    >
      ...
      {project.status && (
        <span className="relative mb-3 inline-flex w-fit items-center gap-1.5 rounded-full border border-pink-300 bg-pink-50 px-3 py-1 text-xs font-semibold text-pink-700">
